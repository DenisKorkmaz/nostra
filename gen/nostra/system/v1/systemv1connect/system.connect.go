...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/DenisKorkmaz/nostra/gen/nostra/system/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SystemServiceName = "nostra.system.v1.SystemService"
)
...
const (
	...
	SystemServicePingProcedure = "/nostra.system.v1.SystemService/Ping"
)

// SystemServiceClient is a client for the nostra.system.v1.SystemService service.
type SystemServiceClient interface {
	Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error)
}

// NewSystemServiceClient constructs a client for the nostra.system.v1.SystemService service. By
...
func NewSystemServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SystemServiceClient {
	...
	systemServiceMethods := v1.File_nostra_system_v1_system_proto.Services().ByName("SystemService").Methods()
...
// Ping calls nostra.system.v1.SystemService.Ping.
...
// SystemServiceHandler is an implementation of the nostra.system.v1.SystemService service.
...
func NewSystemServiceHandler(svc SystemServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/nostra.system.v1.SystemService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSystemServiceHandler) Ping(context.Context, *connect.Request[v1.PingRequest]) (*connect.Response[v1.PingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("nostra.system.v1.SystemService.Ping is not implemented"))
}
